...
for rechnum, img in enumerate(tqdm.tqdm(images)):
    ...
    dilate = cv2.dilate(thresh, kernal, iterations=13)
    ...
    try:
        data = {
            'Person': ocr_string_list[2],
            'Street': ocr_string_list[3],
            'PostalCode_City': ocr_string_list[4],
...
df.to_csv('C:/Users/jmanc/PycharmProjects/InvoiceReaderProject/CLASSIFICATION_MODEL/Pro-clipper_Test/Pro-ClipperDataOutput.csv', sep=';', encoding='utf-8')
