...
pdfs = glob.glob('C:/Users/jmanc/Documents/Jerome Dokus/HTW Studium/Semester 5_HTW/Unternehmenssoftware/Invoice_DATA/Invoices_HP/*.pdf')

# save images in list
for x, pdf in enumerate(tqdm.tqdm(pdfs)):
    pdf_to_image = pdf2image.convert_from_path(pdf, 400)
    pdf_to_image[0].save(f'C:/Users/jmanc/Documents/Jerome Dokus/HTW Studium/Semester 5_HTW/Unternehmenssoftware/Invoice_DATA/Invoices_HP/images/xing{x}.png')
